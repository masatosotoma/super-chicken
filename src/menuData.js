...
export const translations = {
  en: {
    ...
    heroSubtitle: "Premium recipe fried chicken, hand-breaded and cooked to golden perfection. Order now for fast takeout and hot pickups!",
    orderNow: "Order Online",
    viewMenuImg: "View Original Menu",
    categoriesTitle: "Explore Our Menu",
    categoriesSubtitle: "Freshly prepared chicken cooked in trans-fat free oils. Customize your selections below!",
    catAll: "All Items",
    catChicken: "Chicken",
    ...
    locDesc: "123 Crispy Boulevard, Food Town",
    hoursDesc: "Monday - Sunday: 11:00 AM - 10:00 PM",
    contactDesc: "+1 (555) 123-4567",
    footerText: "© 2026 Super Chicken Takeout. All rights reserved.",
    cartTitle: "Your Order",
    cartEmpty: "Your cart is empty. Start adding some crispy chicken!",
    subtotal: "Subtotal",
    tax: "Sales Tax (8%)",
    total: "Total",
    checkout: "Proceed to Pickup Order",
    addToCart: "Add to Order",
    toastAdded: "Added to order!",
    customSpicy: "Spice Level:",
    customSpicyMild: "Mild",
    customSpicyHot: "Spicy",
    customAddons: "Add Extra Toppings:",
    customPineapple: "Add Pineapple (+$1.00)",
    customCheese: "Add Cheese (+$1.50)",
    customUpgradeCombo: "Upgrade to BBQ Chicken Sandwich (+$1.00)",
    receiptSuccess: "Order Confirmed!",
    receiptOrderNum: "Order Number:",
    receiptTime: "Pickup Time:",
    receiptInstructionsTitle: "Instructions for Pickup:",
    receiptInstructions: "Please head to the counter and state your Order Number. Your order will be ready in 15-20 minutes. Pay at counter with cash or card.",
    receiptClose: "Back to Menu",
    quantity: "Qty"
  },
  zh: {
    heroBadge: "酥脆 • 金黄 • 美味",
    heroTitle: "体验极致的 <span>超级炸鸡</span> 美味！",
    heroSubtitle: "优质配方炸鸡，手工裹粉，炸至金黄酥脆。立即下单，快捷外卖，热腾腾取餐！",
    orderNow: "在线点单",
    viewMenuImg: "查看原图菜单",
    categoriesTitle: "探索我们的菜单",
    categoriesSubtitle: "使用无反式脂肪油新鲜烹制的炸鸡。请在下方定制您的选择！",
    catAll: "全部菜单",
    catChicken: "招牌炸鸡",
    catSandwiches: "汉堡与鸡排",
    catSides: "小吃与鸡翅",
    ...
    contactTitle: "电话订餐",
    locDesc: "美食城酥脆大道123号",
    hoursDesc: "周一至周日：上午 11:00 - 晚上 10:00",
    contactDesc: "+1 (555) 123-4567",
    footerText: "© 2026 超级炸鸡外卖。版权所有。",
    cartTitle: "我的订单",
    cartEmpty: "您的购物车是空的。快来添加美味炸鸡吧！",
    subtotal: "小计",
    tax: "消费税 (8%)",
    total: "总计",
    checkout: "确认订单并取餐",
    ...
    receiptSuccess: "订单已确认！",
    receiptOrderNum: "订单编号：",
    receiptTime: "预计取餐时间：",
    receiptInstructionsTitle: "取餐提示：",
    receiptInstructions: "请前往收银台并报出您的订单编号。您的餐点将在 15-20 分钟内准备就绪。可在柜台使用现金或刷卡支付。",
    receiptClose: "返回菜单",
    quantity: "数量"
  }
};
